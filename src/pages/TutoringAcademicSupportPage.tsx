...
import TutoringAcademicSupport from "../components/ui/TutoringAcademicSupport";
import MightBeInterested from "../components/categories/tutoringAndAcademicSupport/MightBeInterested";

const TutoringAcademicSupportPage = () => {
  return (
    <>
...
export default TutoringAcademicSupportPage;
