...
import WritingResearchSupport from "../components/ui/WritingResearchSupport";

const WritingResearchSupportPage = () => {
  return (
    <>
...
export default WritingResearchSupportPage;
