...
import TestPrepStudyResources from "../components/ui/TestPrepStudyResources";

const TestPrepStudyResourcesPage = () => {
  return (
    <>
...
export default TestPrepStudyResourcesPage;
