...
const items = [
  {
    ...
    link: "/tutoring-academic-support",
  },
  {
    id: 2,
  ...
  {
    id: 4,
    title: "Writing & Research Support",
    icon: <MdEditDocument />,
    link: "/writing-research-support",
  },
  {
    id: 5,
    title: "STEM & Coding Lessons",
    icon: <FaLaptopCode />,
    link: "/coding-lessons",
  },
  {
  ...
  },
  {
    ...
    link: "/academic-consulting-advising",
  },
  {
    id: 8,
    title: "Arts & Creative Learning",
    icon: <MdSurfing />,
    link: "/arts-creative-learning",
  },
];
    ...
    <div className="relative z-20 mx-auto max-w-7xl text-center font2">
      ...
      <div className="hidden lg:grid grid-cols-4 xl:grid-cols-8 gap-6">
        {items.map((item) => (
          <Link to={item.link} key={item.id}>
            <div className="hover:-translate-y-2 group bg-neutral-50 duration-500 flex text-black flex-col justify-center items-center relative rounded-xl overflow-hidden shadow-md ">
              <svg
                viewBox="0 0 200 200"
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 lg:hidden m-4">
        {items.slice(0, 8).map((item) => (
          <Link to={item.link} key={item.id}>
            <div className="hover:-translate-y-2 group bg-neutral-50 duration-500 w-full h-auto flex text-black flex-col justify-center items-center relative rounded-xl overflow-hidden shadow-md ">
              <svg
                viewBox="0 0 200 200"
                xmlns="http://www.w3.org/2000/svg"
                className="absolute blur z-10 fill-red-300 duration-500 group-hover:blur-none group-hover:scale-105"
